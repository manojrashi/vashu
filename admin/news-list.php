 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage News</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add News"  class="button btn-success" onclick="location.href='news-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
            ...
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<td><?php echo substr($line->content,0,200); ?></td>
					<td><?php if(is_file("../upload_images/news/thumb/".$line->photo)){?>
                                <img src="../upload_images/news/thumb/<?php echo  $line->photo;?>" height="100px;" width="100px;"/>
                                <?php } ?>
                    </td>
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_news ?>">
		              <div class="slider round"></div>
		            </label>

			          </td>
			          <td><a href="news-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
