  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          <div class="col-md-3 listpage"><h4>Manage Category</h4></div>
          ...
          <div class="col-md-3"><p style="text-align:right">
            <span><input type="button" name="add" value="Add Category"  class="button" onClick="location.href='category-addf.php'" /></span>	
          </p>
        </div>
      </div>
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    while($line=$obj->fetchNextObject($sql)){?>
                      ...
                      <td><?php echo stripslashes($line->category); ?>
                      <td align="center">

                          <label class="switch">
                            <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_category?>">
                            <div class="slider round"></div>
                          </label>

                        </td>
                        <td><a href="category-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                        </td>
                      </tr>
                      <?php $i++; }?>
