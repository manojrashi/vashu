  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
         <div class="col-md-3"><h4>MANAGE VENDOR</h4></div>
         ...
         <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add VENDOR"  class="button btn-success" onclick="location.href='vender-addf.php'" /></span>	
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <form name="frm" method="post" action="city-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="vender-grid" class="table table-bordered table-striped">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php
                  $i=1;
                  $sql=$obj->query("select * from $tbl_user where 1=1 and user_type=2 order by id desc",$debug=-1);
                  ...
                  <td><?php echo ucfirst(stripslashes($line->id)); ?></td>
                  <td><?php echo ucfirst(stripslashes($line->code)); ?><br/><?php echo ucfirst(stripslashes($line->name))." ".ucfirst(stripslashes($line->surname)); ?></td>
                  <td><?php echo ucfirst(stripslashes($line->address)); ?></td>
                  <td><?php echo ucfirst(stripslashes($line->email)); ?></td>
                  <td><?php echo ucfirst(stripslashes($line->mobile)); ?><br/>
                    <?php echo ucfirst(stripslashes($line->contact2)); ?><br/>
                    <?php echo ucfirst(stripslashes($line->contact3)); ?>
                  </td>
                  <td align="center">
                   <label class="switch">
                ...
                <td>
                 <a href="vender-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a></td>
