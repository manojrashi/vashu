...
<div class="wrapper">
 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3 listpage"><h4>Manage Unit</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add Unit"  class="button" onClick="location.href='unit-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
    <form name="frm" method="post" action="unit-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
        ...
        <?php
        $i=1;
        $sql=$obj->query("select * from $tbl_unit where 1=1 order by name asc",$debug=-1);
        while($line=$obj->fetchNextObject($sql)){?>
          ...
          <td align="center">
                ...
                <label class="switch">
                  <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_unit?>">
                  <div class="slider round"></div>
                </label>

          </td>
          <td><a href="unit-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
          </td>
