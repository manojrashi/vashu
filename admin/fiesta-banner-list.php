 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Fiesta Banner</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add Fiesta Banner"  class="button btn-success" onclick="location.href='fiesta-banner-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="fiesta-banner-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_fiesta_banner where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td><?php if(is_file("../upload_images/banner/".$line->photo)){?>
                                <img src="../upload_images/banner/<?php echo  $line->photo;?>" style="width: 150px; height: 100px"/>
                                <?php } ?>
                    </td>
                    <td><?php echo stripslashes($line->price); ?></td>
					<td><?php echo stripslashes($line->target_url); ?></td>
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_fiesta_banner?>">
		              <div class="slider round"></div>
		            </label>

			          </td>
			          <td><a href="fiesta-banner-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
	...
	function del_prompt(frmobj,comb)
		...
		//alert(comb);
			if(comb=='Delete'){
				...
				{
					frmobj.action = "fiesta-banner-del.php";
