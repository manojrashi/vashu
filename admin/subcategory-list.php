  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          <div class="col-md-3 listpage"><h4>Manage Sub Category</h4></div>
          ...
          <div class="col-md-3"><p style="text-align:right">
            <span><input type="button" name="add" value="Add Sub Category"  class="button" onClick="location.href='subcategory-addf.php'" /></span>	
          </p>
        </div>
      </div>
    </section>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                    $sql=$obj->query("select * from $tbl_subcategory where 1=1",$debug=-1);
                    while($line=$obj->fetchNextObject($sql)){?>
                      ...
                      <td><?php echo getField('category',$tbl_category,$line->cat_id); ?>
                      <td><?php echo stripslashes($line->subcategory); ?>
                      <td align="center">

                          <label class="switch">
                            <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_subcategory?>">
                            <div class="slider round"></div>
                          </label>

                        </td>
                        <td><a href="subcategory-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                        </td>
                      </tr>
                      <?php $i++; }?>
...
if(comb=='Delete'){
  ...
  {
    frmobj.action = "subcategory-del.php";
