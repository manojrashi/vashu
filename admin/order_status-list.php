...
<div class="wrapper">
 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3 listpage"><h4>Manage Order Status</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add Order Status"  class="button" onclick="location.href='order_status-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
    <form name="frm" method="post" action="order_status-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="usergroup-grid" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th width="50px">
        ...
        <?php
        $i=1;
        $sql=$obj->query("select * from $tbl_order_status where 1=1 order by id asc",$debug=-1);
        while($line=$obj->fetchNextObject($sql)){?>
          ...
          <td><?php echo ucfirst(stripslashes($line->order_status)); ?></td>
          <td align="center">

                <label class="switch">
                  <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_order_status?>">
                  <div class="slider round"></div>
                </label>

          </td>
          <td><a href="order_status-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
          </td>
  ...
  function del_prompt(frmobj,comb)
    ...
    //alert(comb);
      if(comb=='Delete'){
        ...
        {
          frmobj.action = "order_status-del.php";
