 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Subscriber</h4></div>
            ...
            <div class="box-body">
              <table id="faq-grid" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_newsletter?>">
