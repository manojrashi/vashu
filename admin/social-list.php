 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
           <div class="row">
      	<div class="col-md-3 listpage"><h4>Social List</h4></div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="social-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="social-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_social where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td><?php echo stripcslashes($line->social_url); ?></td>
					<td align="center">
					<label class="switch">
              		<input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_social?>">
		              <div class="slider round"></div>
		            </label>
			          </td>
			          <td><a href="social-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
                </tr>
				<?php $i++; }?>
