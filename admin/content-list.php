  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          <div class="col-md-3 listpage"><h4>Manage Pages</h4></div>
          <div class="col-md-9"><p style="text-align:center"><?php if($_SESSION['sess_msg']){ ?><span class="box-title" style="font-size:12px;color:#a94442"><strong><?php echo $_SESSION['sess_msg'];$_SESSION['sess_msg']='';?></strong></span> <?php }?></p></div>
        </div>
      </section>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <form name="frm" method="post" action="content-del.php" enctype="multipart/form-data">
              <div class="box">
                <div class="box-body">
                  <table id="content-grid" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th width='60px'>
                    ...
                    <tbody>
                      <?php
                      $i=1;
                      $sql=$obj->query("select * from $tbl_content where 1=1 order by id asc",$debug=-1);
                      while($line=$obj->fetchNextObject($sql)){?>
                        <tr>
                          ...
                          <td align="center">
                            <label class="switch">
                              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_content?>">
                              <div class="slider round"></div>
                            </label>
                          </td>
                          <td><a href="content-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                          </td>
                        </tr>
                        <?php $i++; }?>
