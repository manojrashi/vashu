...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="row">
    <div class="col-md-10">
    <div class="col-md-8 listpage"><h4>Manage FAQ Category</h4></div>
    </div>
    <div class="col-md-2">
    <p>
    <span><input type="button" name="add" value="Add FAQ Category"  class="button" onclick="location.href='faqcat-addf.php'" /></span>  
    </p>
  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        <!-- /.box -->
       <form name="frm" method="post" action="faqcat-del.php" enctype="multipart/form-data">
        <div class="box">
          <div class="box-body">
            <table id="faqcategory-grid" class="table table-bordered table-striped">
              <thead>
              <tr>
                <th width="50px">
            ...
            $sql=$obj->query("select * from $tbl_faqcat where 1=1 order by category asc",$debug=-1);
        ...
        <td><?php echo ucfirst(stripslashes($line->category)); ?></td>
        <td align="center">

          <label class="switch">
            <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_faqcat?>">
            <div class="slider round"></div>
          </label>

        </td>
        <td><a href="faqcat-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
        </td>
              </tr>
      <?php $i++; }?>
