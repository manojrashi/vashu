 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage FAQ</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add FAQ"  class="button" onclick="location.href='faq-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
            ...
            <div class="box-body">
              <table id="faq-grid" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<td><?php echo getField('category',$tbl_faqcat,$line->faq_cat);?></td>
					<td><?php echo ucfirst(stripslashes($line->question)); ?></td>
					<td><?php echo ucfirst(stripslashes($line->answer)) ; ?></td>
					<td align="center">
					<label class="switch">
			          ...
			          <td><a href="faq-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
                </tr>
				<?php $i++; }?>
