...
if($_POST['submitForm'] == "yes") {
  ...
  if($new_password==$confirm_password){
    $query=$obj->query("select * from $tbl_vender where id=".$_SESSION['v_user_id'],$debug=-1);
    $result=$obj->fetchNextObject($query);
    if($old_password!=$result->pass){ 
      $_SESSION['sess_msg']='Old Password is Wrong !';
    }else{
      $obj->query("update $tbl_vender set pass='$new_password' where id=".$_SESSION['v_user_id']);
        ...
        <div class="userleft-main">
         ...
         <div class="userimage">
           <form method="POST" enctype="multipart/form-data" action="change-image.php">
            ...
            <span onclick="file_explorer();"><i class="fa fa-upload"></i>Change Password </span>
      ...
      <div class="col-xs-12 col-sm-9 right">
        ...
        <div class="col-xs-12 col-sm-12 input1">
          <div class="grid__item">
            ...
            <input class="o-input required" type="text" id="old_password" name="old_password" placeholder="Old Password">
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 input1">
          <div class="grid__item">
            ...
            <input class="o-input required" type="text" id="new_password" name="new_password" placeholder="New Password">
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 input1">
          <div class="grid__item">
          	<label>Confirm Password</label>
            <input class="o-input required" type="text" id="confirm_password" name="confirm_password" placeholder="Confirm Password*">
          </div>
        </div>
